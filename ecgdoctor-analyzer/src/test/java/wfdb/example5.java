...
public class example5 {
  ...
  public static void main(final String argv[]) {
    ...
    System.out.println("Sampling frequency: " + wfdb.sampfreq(argv[0]) + " Hz");
    System.out.println(nsig + " signals");
    for (i = 0; i < nsig; i++) {
      final WFDB_Siginfo s_i_ = s.getitem(i);
      System.out.println("Group " + s_i_.getGroup() + ", Signal " + i + ":");
      System.out.println(" File: " + s_i_.getFname());
      System.out.println(" Description: " + s_i_.getDesc());
      System.out.print(" Gain: ");
      if (s_i_.getGain() == 0.)
        System.out.print("uncalibrated; assume " + wfdbConstants.WFDB_DEFGAIN);
      else
        System.out.print(s_i_.getGain());
      ...
      if (s_i_.getBsize() == 0)
        System.out.println("can be unbuffered");
      else
        System.out.println(s_i_.getBsize() + "-byte blocks");
      System.out.println(" ADC resolution: " + s_i_.getAdcres() + " bits");
      ...
      if (s_i_.getNsamp() > 0) {
        ...
        System.out.println(" Length undefined");
    }
    wfdb.wfdbquit();
  }
}
