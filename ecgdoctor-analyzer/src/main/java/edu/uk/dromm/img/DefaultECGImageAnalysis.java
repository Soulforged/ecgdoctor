 ...
 * 
 */
public class DefaultECGImageAnalysis implements ImageAnalysis {
	 ...
	 * @param blackValue
	 */
	public DefaultECGImageAnalysis(final int blackValue) {
		super();
	...
	public ECGParameters process(final BufferedImage bi) {
		...
		final List<Point> zeroes = zeroes(allPoints);
		...
		return new ECGParameters(120, 0.0, 10.0, 0.0, 160, 0.0, 1335);
	}
	...
	public List<Point> zeroes(final List<Point> allPoints) {
		final List<Point> ps = allPoints;
